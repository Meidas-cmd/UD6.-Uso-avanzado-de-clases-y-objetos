...
public class Tienda {
    ...
    /**
     * Solicita al usuario el importe y se activva el procesamiento del pago.
     * @param metodo
    ...
    /**
     * Muestra el menú de selección, recoge la opción del usuario y muestra  el método de pago elegido.
     * @author Jorge Cuartero Giner
     * @version 1.0
     */
